...
(defun ИМЕЕТ-СВОЙСТВО (символ свойство &optional (списСв (symbol-plist символ)))
    (cond
       ((NULL списСв) nil)
       ((equal (car списСв) свойство) t)
       (t (ИМЕЕТ-СВОЙСТВО символ свойство (cddr списСВ)))
        )
    )


(SETF (GET 'символ 'свойство1) nil)
(SETF (GET 'символ 'свойство2) 'значение2)

(print (ИМЕЕТ-СВОЙСТВО 'символ 'свойство1))
(print (ИМЕЕТ-СВОЙСТВО 'символ 'свойство2))
(print (ИМЕЕТ-СВОЙСТВО 'символ 'свойство3))
